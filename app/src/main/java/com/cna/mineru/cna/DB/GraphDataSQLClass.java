...
public class GraphDataSQLClass extends AppCompatActivity {
    ...
    public ArrayList<String> get_title(int classId){
        ...
        Cursor cursor = null;
        if(sqliteDb != null){
            String sqlQueryTb1 = "SELECT Title FROM ClassData WHERE ClassId = "+  classId +" AND Term = 1;";
    ...
    public ArrayList<ClassData> set_title(int classId, int isSubsection){
        ...
        Cursor cursor = null;
        if(sqliteDb != null){
            String sqlQueryTb1 = "SELECT Tag, Title FROM ClassData WHERE ClassId = "+  classId +" AND isSubsection = " + isSubsection + " AND Term = 1;";
            System.out.println(sqlQueryTb1);
            cursor = sqliteDb.rawQuery(sqlQueryTb1, null);
            for(int i=0;i<cursor.getCount();i++){
                cursor.moveToNext();
    ...
    public int get_size(int classId, int isSubsection) {
        ...
        Cursor cursor = null;
        if(sqliteDb != null){
            String sqlQueryTb1 = "SELECT Title FROM ClassData WHERE ClassId = "+  classId +" AND isSubsection = " + isSubsection + " AND Term = 1;";
            System.out.println(sqlQueryTb1);
            cursor = sqliteDb.rawQuery(sqlQueryTb1, null);
            for(int i=0;i<cursor.getCount();i++){
                cursor.moveToNext();
    ...
    public void first(){
        ...
        s_list.add(new ClassData(15,0,"2-2. 공약수와 최대공약수",2,1));
        s_list.add(new ClassData(15,0,"2-3. 공배수와 최소공배수",2,1));

        s_list.add(new ClassData(15,0,"3. 규칙과 대응",3,0));
        s_list.add(new ClassData(15,0,"3-1. 두 양 사이의 관계 알아보기",3,1));
        s_list.add(new ClassData(15,0,"3-2. 대응 관계를 식으로 나타내기",3,1));

        s_list.add(new ClassData(15,0,"4. 약분과 통분",4,0));
        s_list.add(new ClassData(15,0,"4-1. 크기가 같은 분수 알아보기",4,1));
        s_list.add(new ClassData(15,0,"4-2. 약분과 통분",4,1));
        s_list.add(new ClassData(15,0,"4-3. 분수와 소수의 크기 비교하기",4,1));

        s_list.add(new ClassData(15,0,"5. 분수의 덧셈과 뺄셈",5,0));
        s_list.add(new ClassData(15,0,"5-1. 분수의 덧셈",5,1));
        s_list.add(new ClassData(15,0,"5-2. 분수의 뺄셈",5,1));

        s_list.add(new ClassData(15,0,"6. 다각형의 둘레와 넓이",6,0));
        s_list.add(new ClassData(15,0,"6-1. 정다각형의 둘레, 사각형의 둘레",6,1));
        s_list.add(new ClassData(15,0,"6-2. 넓이의 단위",6,1));
        s_list.add(new ClassData(15,0,"6-3. 평행사변형, 삼각형, 마름모, 사다리꼴의 넓이",6,1));
        ...
        s_list.add(new ClassData(15,1,"2-2. (자연수)X(분수)",2,1));
        s_list.add(new ClassData(15,1,"2-3. (진분수)X(진분수)",2,1));
        s_list.add(new ClassData(15,1,"2-4. 여러가지 분수의 곱셈",2,1));

        s_list.add(new ClassData(15,1,"3. 합동과 대칭",3,0));
        s_list.add(new ClassData(15,1,"3-1. 도형의 합동",3,1));
        s_list.add(new ClassData(15,1,"3-2. 합동인 도형의 성질",3,1));
        s_list.add(new ClassData(15,1,"3-3. 선대칭도형",3,1));
        s_list.add(new ClassData(15,1,"3-4. 선대칭도형의 성질과 그리기",3,1));
        s_list.add(new ClassData(15,1,"3-5. 점대칭도형",3,1));
        s_list.add(new ClassData(15,1,"3-6. 점대칭도형의 성질과 그리기",3,1));

        s_list.add(new ClassData(15,1,"4. 소수의 곱셈",4,0));
        s_list.add(new ClassData(15,1,"4-1. (1보다 작은 소수)X(자연수)",4,1));
        s_list.add(new ClassData(15,1,"4-2. (1보다 큰 소수)X(자연수)",4,1));
        s_list.add(new ClassData(15,1,"4-3. (자연수)X(1보다 작은 소수)",4,1));
        s_list.add(new ClassData(15,1,"4-4. (자연수)X(1보다 큰 소수)",4,1));
        s_list.add(new ClassData(15,1,"4-5. 1보다 작은 소수끼리의 곱셈",4,1));
        s_list.add(new ClassData(15,1,"4-6. 1보다 큰 소수끼리의 곱셈",4,1));
        s_list.add(new ClassData(15,1,"4-7. 곱의 소수점 위치",4,1));

        s_list.add(new ClassData(15,1,"5. 직육면체",5,0));
        s_list.add(new ClassData(15,1,"5-1. 직육면체",5,1));
        s_list.add(new ClassData(15,1,"5-2. 정육면체",5,1));
        s_list.add(new ClassData(15,1,"5-3. 직육면체의 성질",5,1));
        s_list.add(new ClassData(15,1,"5-4. 직육면체의 겨냥도",5,1));
        s_list.add(new ClassData(15,1,"5-5. 정육면체의 전개도",5,1));
        s_list.add(new ClassData(15,1,"5-6. 직육면체의 전개도",5,1));

        s_list.add(new ClassData(15,1,"6. 평균과 가능성",6,0));
        s_list.add(new ClassData(15,1,"6-1. 평균",6,1));
        s_list.add(new ClassData(15,1,"6-2. 평균 구하기",6,1));
        s_list.add(new ClassData(15,1,"6-3. 평균을 이용하여 문제 해결하기",6,1));
        s_list.add(new ClassData(15,1,"6-4. 일이 일어날 가능성을 말로 표현하기",6,1));
        s_list.add(new ClassData(15,1,"6-5. 일이 일어날 가능성을 비교하기",6,1));
        s_list.add(new ClassData(15,1,"6-6. 일이 일어날 가능성을 수로 표현하기",6,1));
        ...
        s_list.add(new ClassData(16,1,"2-2. 자릿수가 같은 (소수)/(소수)",2,1));
        s_list.add(new ClassData(16,1,"2-3. 자릿수가 다른 (소수)/(소수)",2,1));
        s_list.add(new ClassData(16,1,"2-4. (자연수)/(소수)",2,1));
        s_list.add(new ClassData(16,1,"2-5. 몫을 반올림하여 나타내기",2,1));
        s_list.add(new ClassData(16,1,"2-6. 나누어 주고 남는 양 알아보기",2,1));

        s_list.add(new ClassData(16,1,"3. 공간과 입체",3,0));
        s_list.add(new ClassData(16,1,"3-1. 어느 방향에서 본 것인지 알아보기",3,1));
        s_list.add(new ClassData(16,1,"3-2. 쌓은 모양과 위에서 본 모양으로 쌓기나무의 개수 구하기",3,1));
        s_list.add(new ClassData(16,1,"3-3. 위, 앞, 옆에서 본 모양으로 쌓은 모양과 쌓기 나무의 개수 구하기",3,1));
        s_list.add(new ClassData(16,1,"3-4. 위에서 본 모양에 수를 쓰는 방법으로 쌓은 모양과 쌓기나무의 개수 구하기",3,1));
        s_list.add(new ClassData(16,1,"3-5. 층별로 나타낸 모양으로 쌓은 모양과 쌓기 나무의 개수 구하기",3,1));
        s_list.add(new ClassData(16,1,"3-6. 여러가지 모양 만들기",3,1));

        s_list.add(new ClassData(16,1,"4. 비례식과 비례배분",4,0));
        s_list.add(new ClassData(16,1,"4-1. 비의 성질 알아보기",4,1));
        s_list.add(new ClassData(16,1,"4-2. 간단한 자연수의 비로 나타내기",4,1));
        s_list.add(new ClassData(16,1,"4-3. 비례식 알아보기",4,1));
        s_list.add(new ClassData(16,1,"4-4. 비례식의 성질 알아보기",4,1));
        s_list.add(new ClassData(16,1,"4-5. 비례식의 활용",4,1));
        s_list.add(new ClassData(16,1,"4-6. 비례배분 알아보기",4,1));
        s_list.add(new ClassData(16,1,"4-7. 비례배분의 활용",4,1));

        s_list.add(new ClassData(16,1,"5. 원의 넓이",5,0));
        s_list.add(new ClassData(16,1,"5-1. 원주의 지름의 관계",5,1));
        s_list.add(new ClassData(16,1,"5-2. 원주율",5,1));
        s_list.add(new ClassData(16,1,"5-3. 원주 구하기",5,1));
        s_list.add(new ClassData(16,1,"5-4. 지름 구하기",5,1));
        s_list.add(new ClassData(16,1,"5-5. 원의 넓이 어림하기",5,1));
        s_list.add(new ClassData(16,1,"5-6. 원의 넓이 구하는 방법 알아보기",5,1));
        s_list.add(new ClassData(16,1,"5-7. 여러 가지 원의 넓이 구하기",5,1));
        ...
        s_list.add(new ClassData(16,1,"6-3. 원뿔 알아보기",6,1));
        s_list.add(new ClassData(16,1,"6-4. 구 알아보기",6,1));
        s_list.add(new ClassData(16,1,"6-5. 여러 가지 모양 만들기",6,1));
        ...
        s_list.add(new ClassData(21,0,"2-2. 정수와 유리수의 계산",2,1));

        s_list.add(new ClassData(21,0,"3. 문자와 식",3,0));
        s_list.add(new ClassData(21,0,"3-1. 문자의 사용과 식의 계산",3,1));
        s_list.add(new ClassData(21,0,"3-2. 일차방정식의 풀이",3,1));
        s_list.add(new ClassData(21,0,"3-3. 일차방정식의 활용",3,1));

        s_list.add(new ClassData(21,0,"4. 좌표평면과 그래프",4,0));
        s_list.add(new ClassData(21,0,"4-1. 좌표와 그래프",4,1));
        s_list.add(new ClassData(21,0,"4-2. 정비례와 반비례",4,1));
        ...
        s_list.add(new ClassData(21,1,"2-2. 원과 부채꼴",2,1));

        s_list.add(new ClassData(21,1,"3. 입체 도형",3,0));
        s_list.add(new ClassData(21,1,"3-1. 다면체와 회전체",3,1));
        s_list.add(new ClassData(21,1,"3-2. 입체도형의 겉넓이와 부피",3,1));
        ...
        s_list.add(new ClassData(22,0,"2-2. 연립일차방정식",2,1));

        s_list.add(new ClassData(22,0,"3. 일차함수",3,0));
        s_list.add(new ClassData(22,0,"3-1. 일차함수와 그래프",3,1));
        s_list.add(new ClassData(22,0,"3-2. 일차함수와 일차방정식의 관계",3,1));
        ...
        s_list.add(new ClassData(22,1,"2-2. 여러 가지 사각형",2,1));

        s_list.add(new ClassData(22,1,"3. 도형의 닮음과 피타고라스 정리",3,0));
        s_list.add(new ClassData(22,1,"3-1. 도형의 닮음",3,1));
        s_list.add(new ClassData(22,1,"3-2. 평행선과 선분의 길이의 비",3,1));
        s_list.add(new ClassData(22,1,"3-3. 삼각형의 무게중심",3,1));
        s_list.add(new ClassData(22,1,"3-4. 피타고라스 정리",3,1));

        s_list.add(new ClassData(22,1,"4. 확률",4,0));
        s_list.add(new ClassData(22,1,"4-1. 경우의 수",4,1));
        s_list.add(new ClassData(22,1,"4-2. 확률",4,1));
        ...
        s_list.add(new ClassData(23,0,"3-2. 이차방정식의 활용",3,1));

        s_list.add(new ClassData(23,0,"4. 이차함수",4,0));
        s_list.add(new ClassData(23,0,"4-1. 이차함수와 그 그래프",4,1));
        s_list.add(new ClassData(23,0,"4-2. 이차함수의 그래프와 활용",4,1));
        ...
        s_list.add(new ClassData(23,1,"2-2. 피타고라스 정리의 활용",2,1));

        s_list.add(new ClassData(23,1,"3. 삼각비",3,0));
        s_list.add(new ClassData(23,1,"3-1. 삼각비",3,1));
        s_list.add(new ClassData(23,1,"3-2. 삼각비의 활용",3,1));

        s_list.add(new ClassData(23,1,"4. 원의 성질",4,0));
        s_list.add(new ClassData(23,1,"4-1. 원과 직선",4,1));
        s_list.add(new ClassData(23,1,"4-2. 원주각",4,1));
        s_list.add(new ClassData(23,1,"4-3. 원주각의 활용",4,1));
        ...
        s_list.add(new ClassData(31,0,"2-2. 이차방정식",2,1));
        s_list.add(new ClassData(31,0,"2-3. 이차방정식과 이차함수",2,1));
        s_list.add(new ClassData(31,0,"2-4. 여러가지 방정식",2,1));
        s_list.add(new ClassData(31,0,"2-5. 여러가지 부등식",2,1));

        s_list.add(new ClassData(31,0,"3. 도형의 방정식",3,0));
        s_list.add(new ClassData(31,0,"3-1. 평면좌표",3,0));
        s_list.add(new ClassData(31,0,"3-2. 직선의 방정식",3,0));
        s_list.add(new ClassData(31,0,"3-3. 원의 방정식",3,0));
        s_list.add(new ClassData(31,0,"3-4. 도형의 이동",3,0));
        ...
        s_list.add(new ClassData(31,1,"2-2. 유리함수와 무리함수",2,1));

        s_list.add(new ClassData(31,1,"3. 경우의 수",3,0));
        s_list.add(new ClassData(31,1,"3-1. 합의 법칙과 곱의 법칙",3,0));
        s_list.add(new ClassData(31,1,"3-2. 순열과 조합",3,0));
        ...
        s_list.add(new ClassData(32,0,"2-2. 삼각함수의 그래프",2,1));
        s_list.add(new ClassData(32,0,"2-3. 삼각함수의 활용",2,1));

        s_list.add(new ClassData(32,0,"3. 수열",3,0));
        s_list.add(new ClassData(32,0,"3-1. 등차수열과 등비수열",3,1));
        s_list.add(new ClassData(32,0,"3-2. 수열의 합",3,1));
        s_list.add(new ClassData(32,0,"3-3. 수학적 귀납법",3,1));
        ...
        s_list.add(new ClassData(33,1,"2. 미분",2,0));
        s_list.add(new ClassData(33,1,"2-1. 미분계수와 도함수",2,1));
        s_list.add(new ClassData(33,1,"2-2. 도함수의 활용",2,1));

        s_list.add(new ClassData(33,1,"3. 적분",3,0));
        s_list.add(new ClassData(33,1,"3-1. 부정적분",3,1));
        s_list.add(new ClassData(33,1,"3-2. 정적분",3,1));
        s_list.add(new ClassData(33,1,"3-3. 정적분의 활용",3,1));
